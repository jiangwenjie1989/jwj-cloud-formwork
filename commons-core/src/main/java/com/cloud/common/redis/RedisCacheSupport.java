 ...
 */
@Repository
public class RedisCacheSupport<V> {
	...
	public void put(final String key, final V value, final Long expire) {
		redisTemplate.execute(new RedisCallback<Object>() {
			...
			public Object doInRedis(RedisConnection connection) throws DataAccessException {
				...
				connection.set(kb, redisSerializer.serialize(value));
				if (expire != null){
	 ...
	 * @param value
	 */
	public void append(final String key, final V value){
		redisTemplate.execute(new RedisCallback<Object>() {
			@Override
			public Object doInRedis(RedisConnection connection) throws DataAccessException {
				byte[] kb = key.getBytes();
				/* connection.select(dbIndex);  */
//				connection.openPipeline();
				connection.append(kb, redisSerializer.serialize(value));
				return null;
			}
	 ...
	 * @return
	 */
	public V getCached(final String key) {
	...
	public void updateCached(final String key, final V value, final Long expireSec) throws Exception {
...
//	}
	...
	public List<V> mGet(final Object... keys) {
		...
		for (byte[] bs : byteList) {
			result.add(redisSerializer.deserialize(bs));
		}
		return result;
	}


//	private void _mSet(final Map<byte[], byte[]> tuple,final Long expire) {
//		redisTemplate.setEnableTransactionSupport(true);
//		redisTemplate.execute(new RedisCallback<Object>() {
//			public Object doInRedis(RedisConnection connection) throws DataAccessException {
//				/* connection.select(dbIndex);  */
...
//				if(expire!=null){
//					for (byte[] bskey : tuple.keySet()) {
//						connection.expire(bskey, expire);
//					}
//				}
//				return null;
//			}
...
//	}
	 ...
	 * @return
	 */
	public Boolean putHashCached(final String key, final String mapkey, final V value) {
	 ...
	 * @return
	 */
	public V getHashCached(final String key, final String mapkey) {
		return redisTemplate.execute(new RedisCallback<V>() {
			@Override
	 ...
	 * @return
	 */
	public Long getHashSize(final int dbIndex,final String key)  {
		return redisTemplate.execute(new RedisCallback<Long>() {
			@Override
			public Long doInRedis(RedisConnection connection) throws DataAccessException {
				/* connection.select(dbIndex);  */
	...
	public List<V> getHashValues(final String key) {
		return redisTemplate.execute(new RedisCallback<List<V>>() {
			...
			public List<V> doInRedis(RedisConnection connection) throws DataAccessException {
				...
				for (byte[] bs : hVals) {
					list.add(redisSerializer.deserialize(bs));
				}
				return list;
	 ...
	 * @throws Exception
	 */
	public Map<String,V> hGetAll(final int dbIndex,final String key) throws Exception {
		return redisTemplate.execute(new RedisCallback<Map<String,V>>() {
			...
			public Map<String,V> doInRedis(RedisConnection connection) throws DataAccessException {
				...
				for (byte[] field : hashValues.keySet()) {
					maps.put(new String(field), redisSerializer.deserialize(hashValues.get(field)));
				}
				return maps;
			}
		});
	 ...
	 * @return
	 */
	public boolean hExists(final int dbIndex,final String key,final String mapkey){
		return redisTemplate.execute(new RedisCallback<Boolean>() {
			@Override
	 ...
	 * @return
	 */
	public List<V> hMGet(final int dbIndex,final String key, final Object... fields) {	
		return redisTemplate.execute(new RedisCallback<List<V>>() {
	 ...
	 * @param tuples
	 */
	public void zAdd(final int dbIndex,final String key, final LinkedHashSet<V> tuples) {
		redisTemplate.execute(new RedisCallback<Object>() {
			@Override
			public Object doInRedis(RedisConnection connection) throws DataAccessException {
				/* connection.select(dbIndex);  */
	 ...
	 * @return
	 */
	public Set<V> zRange(final int dbIndex,final String key, final long begin, final long end) {
		return redisTemplate.execute(new RedisCallback<Set<V>>() {
			@Override
			public Set<V> doInRedis(RedisConnection connection) throws DataAccessException {
				/* connection.select(dbIndex);  */
	 ...
	 * @param value
	 */
	public void zAdd(final int dbIndex,final String key,int score,final V value){
		 redisTemplate.execute(new RedisCallback<Object>() {
			@Override
			public Object doInRedis(RedisConnection connection) throws DataAccessException {
				/* connection.select(dbIndex);  */
				connection.zAdd(key.getBytes(), score, redisSerializer.serialize(value));
				return null;
			}
		});
	}
	 ...
	 * @return
	 */
	public Set<V> zRangeScore(final String key,int min,int max){
		return redisTemplate.execute(new RedisCallback<Set<V>>() {
			@Override
			public Set<V> doInRedis(RedisConnection connection) throws DataAccessException {
				/* connection.select(dbIndex);  */
	...
	public Long sAdd(final String key,final Object...value){
		 return redisTemplate.execute(new RedisCallback<Long>() {
			...
			public Long doInRedis(RedisConnection connection) throws DataAccessException {
				...
				return connection.sAdd(key.getBytes(), byteValues);
	...
	public void sRem(final String key,final Object...value){
		 redisTemplate.execute(new RedisCallback<Object>() {
			...
			public Object doInRedis(RedisConnection connection) throws DataAccessException {
				...
				connection.sRem(key.getBytes(), byteValues);
	...
	public boolean sIsMember(final String key,final V value){
		return redisTemplate.execute(new RedisCallback<Boolean>() {
			...
			public Boolean doInRedis(RedisConnection connection) throws DataAccessException {
				/* connection.select(dbIndex);  */
				return connection.sIsMember(key.getBytes(), redisSerializer.serialize(value));
			}
		});
	}
	...
	public Long lPush(final String key,final Object...value){
		return redisTemplate.execute(new RedisCallback<Long>() {
			...
			public Long doInRedis(RedisConnection connection) throws DataAccessException {
				...
				return connection.lPush(key.getBytes(), byteValues);
			}
		});
	}
...
//	}
     ...
     * reids 服务器 bgsave
	 */
	public void saveDb(final int dbIndex) {
		redisTemplate.execute(new RedisCallback<Object>() {
			@Override
			public Object doInRedis(RedisConnection connection) throws DataAccessException {
				/* connection.select(dbIndex);  */
	 ...
	 * @throws Exception
	 */
	public Long getDBSize(final int dbIndex ) throws Exception {
		return redisTemplate.execute(new RedisCallback<Long>() {
			@Override
			public Long doInRedis(RedisConnection connection) throws DataAccessException {
				/* connection.select(dbIndex);  */
	 ...
	 * @throws Exception
	 */
	public void clearDB(final int dbIndex) throws Exception {
