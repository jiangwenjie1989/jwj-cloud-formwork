...
public class ValidationUtils {  
     ...
     */
    public static final String MOBILE ="^(13[0-9]|14[579]|15[0-3,5-9]|16[6]|17[0135678]|18[0-9]|19[89])\\d{8}$";  
...
////------------------验证方法       
    ...
    /**
     * @Title: isStrsNull  
     * @Description: 判断多个字符串是否存在一个为空的,存在返回true 
     * @param strs
     * @return
     * @return boolean
     * @author ycs 
     * @date 2018年5月31日
     */
    public static boolean isStrsNull(String...  strs) { 
        boolean flag = false;
