...
/**
 * @ClassName : RSAUtil  //类名
 * @Description : RSAUtil工具类  //描述
 * @Author : JiangWenJie  //作者
 * @Date: 2020-03-03 18:51  //时间
 */
public class RSAUtil {

    public static String publicKey="MFwwDQYJKoZIhvcNAQEBBQADSwAwSAJBAJnX0CvheEwc6MRvcO/AKZ8TZZUIKgPuPaBk4uZF4lalRWT8gotukQbcR0UMJO1y9NxM8ndAhwO2QHRtK+DCn4sCAwEAAQ=="; // 公钥
    public static String privateKey=""; // 私钥
...
//        System.out.println("私钥给发送方:" + RSAUtil.privateKey);
        ...
        // 公钥加密
        String textsr = "86309351CD1DCD5F06A07093A20DC576";
